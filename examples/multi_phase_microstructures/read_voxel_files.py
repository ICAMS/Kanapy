...
name_d = '../fixtures/dual_phase_voxels.json'
name_p = '../fixtures/porous_voxels.json'

if not (os.path.isfile(name_p) or os.path.isfile(name_d)):
    raise FileNotFoundError('Please run python scripts "porosity.py" and "dual_phase.py" first to ' +
