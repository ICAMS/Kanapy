...
ms_elong = {'Grain type': 'Elongated', 
          'Equivalent diameter': {'std': 1.0, 'mean': 12.0, 'offs': 4.0, 'cutoff_min': 5.0, 'cutoff_max': 20.0},
          'Aspect ratio': {'std':0.8, 'mean': 2.0, 'offs': 0.6, 'cutoff_min': 1.0, 'cutoff_max': 3.5},
