...
def plot_ellipsoids(ms=None, particles=None, cmap='prism', test=False):
    
    if particles is None:
        if ms is None:
            raise ValueError('Either microstructure instance (ms) or particles must be given for plotting.')
        else:
