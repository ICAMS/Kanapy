...
def write_output_stat(nodeDict, elmtDict, elmtSetDict, particle_data, RVE_data, \
...
def extract_volume_sharedGBarea(nodeDict, elmtDict, elmtSetDict, RVE_data, save_files=False):
    r"""
