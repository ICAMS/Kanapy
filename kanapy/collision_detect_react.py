...
import math
import numpy as np
from kanapy.overlapDetect import collideDetect


def collision_routine(E1, E2):
    """
    Calls the c++ method :meth:`kanapy.overlapDetect.collideDetect` to determine if the given two ellipsoid objects overlap using 
    ...
    # Elif ellipsoids
        ...
        # call the c++ method
        overlap_status = collideDetect(E1.get_coeffs(), E2.get_coeffs(), 
