...
def write_abaqus_inp():
    ...
    .. note:: JSON files generated by :meth:`voxelization.voxelixationRoutine` are read to generate the ABAQUS (.inp) file.
...
def write_output_stat():
    ...
    .. note:: Particle information is read from (.json) file generated by :meth:`input_output.particleStatGenerator`.
              And RVE grain information is read from the (.json) files generated by :meth:`voxelization.voxelixationRoutine`.
    """  
